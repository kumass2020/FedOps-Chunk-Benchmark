...
with open('wandb_export_2023-03-23T20_55_44.563+09_00.csv', mode='r') as csv_file:
...
float_lists = [[float(x) / 50.0 for x in str_list] for str_list in str_lists]
